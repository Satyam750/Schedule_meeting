  ...
  return (
    <div className="p-14 items-center flex flex-col gap-20 my-10">
        ...
        <div className="flex flex-col items-center gap-4 max-w-3xl">
            <h2 className="text-4xl font-bold">What shold we call your business</h2>
            <p className="text-slate-500">YOu can always change this later from settings</p>
            <div className="w-full">
                <label className="text-slate-400" htmlFor="">Team Name</label>
                <Input placeholder="Sam" className="mt-2" onChange={(e)=>setBusinessName(e.target.value)} 
